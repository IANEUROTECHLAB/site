(function() {
    ...
    chatWidgetContainer.innerHTML = `
      ...
      <div id="chat-popup" class="hidden absolute bottom-20 right-0 w-96 bg-white rounded-md shadow-md flex flex-col transition-all text-sm">
        <div id="chat-header" class="flex justify-between items-center p-4 bg-gray-800 text-white rounded-t-md">
          <h3 class="m-0 text-lg">Chagas</h3>
        ...
        <div id="chat-input-container" class="p-4 border-t border-gray-200">
          <div class="flex space-x-4 items-center">
            <input type="text" id="chat-input" class="flex-1 border border-gray-300 rounded-md px-4 py-2 outline-none w-3/4" placeholder="Deixe Chagas te ajudar...">
    ...
    function onUserRequest(message) {
      ...
      // Reply to the user
      setTimeout(function() {
        reply('Oi! Estou em desenvolvimento ainda. Mas obrigado por iniciar esta conversa. Estarei pronto o logo, logo.');
      }, 1000);
    }
